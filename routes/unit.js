    ...
    try {
      ...
      if (announcementIds.length > 0) {
        try {
          ...
          console.log('[/unit/dashboard] Marked', announcementIds.length, 'announcements as read');
        } catch (updateError) {
          console.log('[/unit/dashboard] Error marking announcements as read:', updateError.message);
        }
      }
